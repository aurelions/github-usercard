...
*/
import axios from 'axios' //import axios from axios -> package.json dependancy 

//Set up the axios request
axios.get('https://api.github.com/users/aurelions')
.then (i => {
...
const followersArray = [
  ...
  'https://api.github.com/users/ianinho',
  'https://api.github.com/users/AbdulhakimDini'
];
...
function cardMaker(i){
  ...
  profile.appendChild(profileAlink);
